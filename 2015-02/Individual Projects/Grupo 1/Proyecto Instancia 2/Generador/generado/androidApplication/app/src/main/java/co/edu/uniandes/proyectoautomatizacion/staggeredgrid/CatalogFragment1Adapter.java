...
public class CatalogFragment1Adapter extends ArrayAdapter<ProductoDb> {

    private static final String TAG = "CatalogFragment1Adapter";
    ...
    public CatalogFragment1Adapter(final Context context, final int textViewResourceId) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        final ViewHolder vh;
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.catalogfragment1adapter, parent, false);
            vh = new ViewHolder();
        ...
        vh.txtLineOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
				...
				ImageView carritoImageView = (ImageView) dialog.findViewById(R.id.cartImageView);
                TextView nombrePromo = (TextView) dialog.findViewById(R.id.detalle_prod_nombre_text_view);
                TextView descPromo = (TextView) dialog.findViewById(R.id.detalle_prod_descripcion_text_view);

                nombrePromo.setText(getItem(position).getNombre());
                descPromo.setText(getItem(position).getDescripcion());
                
                carritoImageView.setVisibility(View.GONE);
