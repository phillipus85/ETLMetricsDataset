...
public class SampleAdapterPromo extends ArrayAdapter<PromocionDb> {

    private static final String TAG = "SampleAdapterPromo";
    ...
    public SampleAdapterPromo(final Context context, final int textViewResourceId) {
            ...
            public void onClick(final View v) {
                ...
                irATiendaProductoImageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        mWebView.loadUrl(getItem(position).getDetalleUrl());
                ...
                shareProductoImageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        intent.putExtra(Intent.EXTRA_TEXT, getItem(position).getDetalleUrl());

                        getContext().startActivity(Intent.createChooser(intent, "Compartir en:"));
                    }
                });

                Picasso.with(getContext()).load(getItem(position).getImagen()).into(detaProdImageView);
