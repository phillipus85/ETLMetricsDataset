...
public class PromoFragment1Adapter extends ArrayAdapter<PromocionDb> {

    private static final String TAG = "PromoFragment1Adapter";
    ...
    public PromoFragment1Adapter(final Context context, final int textViewResourceId) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        final ViewHolder vh;
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.promofragment1adapter, parent, false);
            vh = new ViewHolder();
