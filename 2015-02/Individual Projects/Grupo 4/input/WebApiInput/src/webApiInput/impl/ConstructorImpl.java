 ...
 * <ul>
 *   <li>{@link webApiInput.impl.ConstructorImpl#getParametros <em>Parametros</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ConstructorImpl extends ObjectImpl implements Constructor {
	/**
	...
	protected EClass eStaticClass() {
		return WebApiInputPackage.Literals.CONSTRUCTOR;
	}
	...
	public EList<Parametro> getParametros() {
		if (parametros == null) {
			parametros = new EObjectContainmentEList<Parametro>(Parametro.class, this, WebApiInputPackage.CONSTRUCTOR__PARAMETROS);
		}
		return parametros;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebApiInputPackage.CONSTRUCTOR__PARAMETROS:
