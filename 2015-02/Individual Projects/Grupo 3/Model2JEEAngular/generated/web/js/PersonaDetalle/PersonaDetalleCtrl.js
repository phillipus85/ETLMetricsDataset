...
angular.module('sistemagestionuniversitario')
  .controller('PersonaDetalleCtrl', function ($scope, $rootScope, $http,  $dialogs, $location, $routeParams) {
	    ...
	    if ($routeParams.id){	    	    
		    ...
		    $http.get("http://localhost:8080/rad/rest/Persona/Persona/"+$routeParams.id)
		...
		$scope.save=function(dataGuardar){
            ...
            if ($routeParams.id){
             $http.put("http://localhost:8080/rad/rest/Persona/Persona", angular.toJson( dataGuardar))
            .success(function(res){
             ...
             $http.post("http://localhost:8080/rad/rest/Persona/Persona", angular.toJson( dataGuardar))
            .success(function(res){
                toastr.success('JEE & Angular', 'Registro exitoso.');                
            }).error(function(res){
                console.log("Doesn't work");
		...
		$scope.eliminar=function(dataEliminar){
             $http.delete("http://localhost:8080/rad/rest/Persona/Persona", angular.toJson( dataEliminar))
            .success(function(res){
