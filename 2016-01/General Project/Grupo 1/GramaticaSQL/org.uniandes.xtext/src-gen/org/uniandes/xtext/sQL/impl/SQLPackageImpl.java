...
import org.uniandes.xtext.sQL.SQLFactory;
...
public class SQLPackageImpl extends EPackageImpl implements SQLPackage
{
   ...
   * @see org.uniandes.xtext.sQL.SQLPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   * @generated
   */
  public EAttribute getColumn_IsNull()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(dataBaseEClass, DATA_BASE__TABLE);

    tableEClass = createEClass(TABLE);
    createEAttribute(tableEClass, TABLE__NAME);
    createEReference(tableEClass, TABLE__COLUMN);
    createEReference(tableEClass, TABLE__PRIMARYKEY);
    createEReference(tableEClass, TABLE__FOREIGNKEY);

    columnEClass = createEClass(COLUMN);
    createEAttribute(columnEClass, COLUMN__NAME);
    createEAttribute(columnEClass, COLUMN__TYPE);
    createEAttribute(columnEClass, COLUMN__IS_NULL);
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getColumn_IsNull(), ecorePackage.getEBoolean(), "isNull", null, 0, 1, Column.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
