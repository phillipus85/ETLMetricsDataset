...
public class InternalGenSqlLexer extends Lexer {
    ...
    public final void mRULE_LONGITUD() throws RecognitionException {
        try {
            ...
            // InternalGenSql.g:527:15: ( RULE_LPARENT RULE_NUMBER RULE_RPARENT )
            // InternalGenSql.g:527:17: RULE_LPARENT RULE_NUMBER RULE_RPARENT
            {
            mRULE_LPARENT(); 
            mRULE_NUMBER(); 
            mRULE_RPARENT(); 
    ...
    public final void mRULE_CREATE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:529:13: ( 'CREATE' )
            // InternalGenSql.g:529:15: 'CREATE'
            {
            match("CREATE"); 
    ...
    public final void mRULE_CTABLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:531:13: ( 'TABLE' )
            // InternalGenSql.g:531:15: 'TABLE'
            {
            match("TABLE"); 
    ...
    public final void mRULE_LPARENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:533:14: ( '(' )
            // InternalGenSql.g:533:16: '('
            {
            match('('); 
    ...
    public final void mRULE_RPARENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:535:14: ( ')' )
            // InternalGenSql.g:535:16: ')'
            {
            match(')'); 
    ...
    public final void mRULE_SEMICOLON() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:537:16: ( ';' )
            // InternalGenSql.g:537:18: ';'
            {
            match(';'); 
    ...
    public final void mRULE_COMMA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:539:12: ( ',' )
            // InternalGenSql.g:539:14: ','
            {
            match(','); 
    ...
    public final void mRULE_FOREIGN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:541:14: ( 'FOREIGN' )
            // InternalGenSql.g:541:16: 'FOREIGN'
            {
            match("FOREIGN"); 
    ...
    public final void mRULE_PRIMARY() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:543:14: ( 'PRIMARY' )
            // InternalGenSql.g:543:16: 'PRIMARY'
            {
            match("PRIMARY"); 
    ...
    public final void mRULE_KEY() throws RecognitionException {
        try {
            int _type = RULE_KEY;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:545:10: ( 'KEY' )
            // InternalGenSql.g:545:12: 'KEY'
            {
            match("KEY"); 
    ...
    public final void mRULE_NULL() throws RecognitionException {
        try {
            int _type = RULE_NULL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:547:11: ( 'NULL' )
            // InternalGenSql.g:547:13: 'NULL'
            {
            match("NULL"); 
    ...
    public final void mRULE_NOT() throws RecognitionException {
        try {
            int _type = RULE_NOT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:549:10: ( 'NOT' )
            // InternalGenSql.g:549:12: 'NOT'
            {
            match("NOT"); 
    ...
    public final void mRULE_REFERENCES() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:551:17: ( 'REFERENCES' )
            // InternalGenSql.g:551:19: 'REFERENCES'
            {
            match("REFERENCES"); 
    ...
    public final void mRULE_TIPO() throws RecognitionException {
        try {
            int _type = RULE_TIPO;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:553:11: ( ( 'varchar' | 'int' | 'String' | 'boolean' | 'date' | 'number' ) )
            // InternalGenSql.g:553:13: ( 'varchar' | 'int' | 'String' | 'boolean' | 'date' | 'number' )
            {
            // InternalGenSql.g:553:13: ( 'varchar' | 'int' | 'String' | 'boolean' | 'date' | 'number' )
            int alt1=6;
            switch ( input.LA(1) ) {
            ...
            switch (alt1) {
                case 1 :
                    // InternalGenSql.g:553:14: 'varchar'
                    {
                    match("varchar"); 
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // InternalGenSql.g:553:30: 'String'
                    {
                    match("String"); 
                    ...
                    break;
                case 4 :
                    // InternalGenSql.g:553:39: 'boolean'
                    {
                    match("boolean"); 
                ...
                case 5 :
                    ...
                    break;
                case 6 :
                    // InternalGenSql.g:553:56: 'number'
                    {
                    match("number"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:555:9: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( '0' .. '9' | 'A' .. 'Z' | 'a' .. 'z' )* )
            // InternalGenSql.g:555:11: ( 'a' .. 'z' | 'A' .. 'Z' ) ( '0' .. '9' | 'A' .. 'Z' | 'a' .. 'z' )*
            {
            ...
            // InternalGenSql.g:555:31: ( '0' .. '9' | 'A' .. 'Z' | 'a' .. 'z' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            // InternalGenSql.g:557:22: ( ( '0' .. '9' )* )
            // InternalGenSql.g:557:24: ( '0' .. '9' )*
            {
            // InternalGenSql.g:557:24: ( '0' .. '9' )*
            loop3:
            do {
    ...
    public final void mRULE_FIN() throws RecognitionException {
        try {
            int _type = RULE_FIN;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:559:10: ( EOF )
            // InternalGenSql.g:559:12: EOF
            {
            match(EOF); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:561:10: ( ( '0' .. '9' )+ )
            // InternalGenSql.g:561:12: ( '0' .. '9' )+
            {
            // InternalGenSql.g:561:12: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:563:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalGenSql.g:563:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalGenSql.g:563:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalGenSql.g:563:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalGenSql.g:563:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                    ...
                    break;
                case 2 :
                    // InternalGenSql.g:563:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalGenSql.g:563:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:565:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalGenSql.g:565:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalGenSql.g:565:24: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:567:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalGenSql.g:567:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalGenSql.g:567:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:569:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalGenSql.g:569:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalGenSql.g:569:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGenSql.g:571:16: ( . )
            // InternalGenSql.g:571:18: .
            {
            matchAny(); 
