 ...
 * <ul>
 *   <li>{@link co.edu.uniandes.genSql.impl.DataBaseImpl#getTables <em>Tables</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataBaseImpl extends MinimalEObjectImpl.Container implements DataBase
{
  ...
  {
    return GenSqlPackage.Literals.DATA_BASE;
  }
  ...
  public EList<Table> getTables()
  {
    if (tables == null)
    {
      tables = new EObjectContainmentEList<Table>(Table.class, this, GenSqlPackage.DATA_BASE__TABLES);
    }
    return tables;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case GenSqlPackage.DATA_BASE__TABLES:
