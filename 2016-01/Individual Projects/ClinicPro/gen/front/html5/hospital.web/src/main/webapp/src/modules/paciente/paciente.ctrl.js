(function (ng) {
    ...
    mod.controller("pacienteCtrl", ["$scope", "$rootScope","pacienteService", function ($scope,$rootScope, svc) {
            ...
            this.getRecord = function (record) {
				...
				return svc.fetchRecord(record.documento).then(function (response){							
